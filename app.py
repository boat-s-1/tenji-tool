...
</div><div style="margin-bottom:10px;"><div style="font-weight:bold;">{i}号艇</div><div class="bar-bg"><div class="bar-fill" style="width:{boat_scores[f"{i}号艇"]}%;">{boat_scores[f"{i}号艇"]}</div></div></div>' for i in range(1,7)])}</div>
